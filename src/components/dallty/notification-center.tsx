...
const strings = {
  en: { title: "Notifications", markAll: "Mark all read", loading: "Loading…", empty: "You're all caught up.", unread: "unread" },
  ar: { title: "الإشعارات", markAll: "تعليم الكل كمقروء", loading: "جارٍ التحميل…", empty: "لا توجد إشعارات جديدة.", unread: "غير مقروء" },
} as const;
