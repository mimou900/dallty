...
- **Wilaya/Commune get bilingual names (French + Arabic) and the full real dataset** (58 wilayas, ~1,541 communes) seeded now, not a placeholder — matching how the existing `COUNTRIES` array already carries `name`/`nameAr`.
